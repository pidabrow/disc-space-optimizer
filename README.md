...
Specification and implementation plan: [`docs/disk_optimizer_implementation_plan.md`](docs/disk_optimizer_implementation_plan.md). **It does not delete files**, export JSON/CSV, scan in parallel, or follow symbolic links; no third-party dependencies (stdlib only).
